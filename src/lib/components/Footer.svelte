...
<footer class="text-gray-600 body-font bg-stone-200 mt-4">
  <div class="container max-w-4xl px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© {now.getFullYear()} {APP_NAME} — All rights reserved.
    </p>
