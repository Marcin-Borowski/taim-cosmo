...
<form method="POST" action="?/create" class="mx-auto max-w-3xl bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
  ...
  <div class="flex space-x-4">
    <div class="mb-4">
      ...
      <input type="date" bind:value={date} class="form-input shadow appearance-none border border-stone-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
    </div>
